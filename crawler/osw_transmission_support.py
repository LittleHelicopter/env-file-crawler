...
# 配置日志记录
logging.basicConfig(filename="../logs/osw_transmission_support.txt",  # 日志文件名
...
start_urls = ["https://www.energy.gov/gdo/offshore-wind-transmission-federal-planning-support"]

# 为每个 URL 生成简短的文件名
url_to_filename = {
    "https://www.energy.gov/gdo/offshore-wind-transmission-federal-planning-support": "osw_transmission_support"
}
