...
# 定义页面的基本 URL 和请求头
base_url = 'https://www.fisheries.noaa.gov/feature-story/bureau-ocean-energy-management-and-noaa-demonstrate-power-government-wide-approach'
headers = {
...
# 定义保存文件的基本文件夹路径
base_save_folder = r"../data/noaa_boem_noaa_power_approach/"
