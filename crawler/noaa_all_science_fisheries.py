"""
以下页面中的七个链接
https://www.fisheries.noaa.gov/resources/all-science?title=&field_topics_vocab_target_id%5B1000357851%5D=1000357851&field_species_vocab_target_id=&sort_by=created
"""
...
# 这里是包含多个起始 URL 的列表
start_urls = [
    "https://www.fisheries.noaa.gov/science-blog/sound-bytes-its-boat-its-plane-its-passive-acoustic-ocean-glider",
...
# 为每个 URL 生成简短的文件名
url_to_filename = {
    "https://www.fisheries.noaa.gov/science-blog/sound-bytes-its-boat-its-plane-its-passive-acoustic-ocean-glider": "boat-plane-passive-acoustic-glider",
    "https://www.fisheries.noaa.gov/resource/data/socioeconomic-impacts-atlantic-offshore-wind-development": "socioeconomic-offshore-wind",
    "https://www.fisheries.noaa.gov/resource/data/noaa-nefsc-north-atlantic-right-whale-acoustic-data-and-annotations": "noaa-right-whale-acoustic",
    "https://www.fisheries.noaa.gov/science-blog/sound-bytes-waving-goodbye-adrift-fieldwork": "waving-goodbye-adrift",
    "https://www.fisheries.noaa.gov/science-blog/sound-bytes-learning-through-experience": "learning-through-experience",
    "https://www.fisheries.noaa.gov/science-blog/sound-bytes-adventures-drifting-buoy": "adventures-drifting-buoy",
    "https://www.fisheries.noaa.gov/resource/map/north-atlantic-right-whale-sightings": "north-atlantic-whale-sightings"
}

# 定义根保存文件夹路径
root_save_folder = r"../data/noaa_all_science_fisheries/"
