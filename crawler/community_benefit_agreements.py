"""
https://windexchange.energy.gov/projects/community-benefit-agreements
仅抓取两层
"""
...
# 配置日志记录
logging.basicConfig(filename="../logs/community_benefit_agreements.txt",  # 日志文件名
...
start_urls = ["https://windexchange.energy.gov/projects/community-benefit-agreements"]

# 为每个 URL 生成简短的文件名
url_to_filename = {
    "https://windexchange.energy.gov/projects/community-benefit-agreements": "community_benefit_agreements"
}
...
def process_first_and_second_layer(base_url, pdf_folder, other_files_folder):
    ...
    try:
        # 获取当前页面的链接
        # start链接页面上的链接
        links = get_links_from_specific_div_dynamic(base_url)
