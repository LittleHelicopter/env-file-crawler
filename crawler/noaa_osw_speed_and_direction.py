...
# 定义页面的基本 URL 和请求头
base_url = 'https://www.fisheries.noaa.gov/inport/item/66216'
...
links = [urljoin(base_url, a['href']) for a in soup.select('.col-1 a[href]')]

# 定义保存文件的基本文件夹路径
base_save_folder = r"../data/noaa_osw_speed_and_direction/"
