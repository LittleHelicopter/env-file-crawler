...
from utils.web_utils import get_links_from_specific_div

# links = get_links_from_specific_div("https://www.nrel.gov/wind/offshore-wind.html", "list-unstyled list-links")
#
# print(links)
# print(len(links))
#
# save_url_to_file("nrel_osw_links.txt", links)
...
# 定义页面的基本 URL 和请求头
base_url = 'https://www.nrel.gov/wind/offshore-wind.html'
headers = {
...
# 定义保存文件的基本文件夹路径
base_save_folder = r"../data/nrel_osw/first_page/"
