...
# 配置日志记录
logging.basicConfig(filename="../logs/osw_research_development.txt",  # 日志文件名
...
start_urls = ["https://www.energy.gov/eere/wind/offshore-wind-research-and-development"]

# 为每个 URL 生成简短的文件名
url_to_filename = {
    "https://www.energy.gov/eere/wind/offshore-wind-research-and-development": "osw_research_development"
}
