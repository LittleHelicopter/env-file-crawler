...
# 配置日志记录
logging.basicConfig(filename="../logs/wind_vision_1.txt",  # 日志文件名
...
start_urls = ["https://www.energy.gov/eere/wind/wind-vision-1"]

# 为每个 URL 生成简短的文件名
url_to_filename = {
    "https://www.energy.gov/eere/wind/wind-vision-1": "wind_vision_1"
}
